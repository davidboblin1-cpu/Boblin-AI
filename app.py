...
st.markdown("""
    <style>
        ...
        /* Masque complètement le badge flottant Streamlit en bas à droite */
        [data-testid="stStatusWidget"] {visibility: hidden; display: none;}
        div[class*="viewerBadge"] {visibility: hidden; display: none;}

        /* Ajustement des marges (plus besoin de laisser de l'espace pour les bannières fixes) */
        .block-container {
...
# ---------------------------------------------------------
# BARRE DE NAVIGATION SUPÉRIEURE (SANS GITHUB)
# ---------------------------------------------------------
