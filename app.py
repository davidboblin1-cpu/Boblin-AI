...
# ---------------------------------------------------------
# STYLE CSS POUR MASQUER LE MENU ET FIXER LES PUBS
# ---------------------------------------------------------
st.markdown("""
    <style>
        ...
        /* Fixe la bannière publicitaire tout en haut */
        .fixed-top-ad {
            position: sticky;
            top: 0px;
            z-index: 99999;
        ...
        /* Fixe la bannière publicitaire juste au-dessus de la barre de chat */
        .fixed-bottom-ad {
            position: fixed;
            bottom: 70px;
            left: 0;
        ...
        /* Ajoute de l'espace en bas de la page pour ne pas masquer le contenu sous la pub fixe */
        .block-container {
...
# Gestion d'un identifiant utilisateur unique par navigateur
...
# 1. Bannière publicitaire épinglée tout en haut
st.markdown('<div class="fixed-top-ad">', unsafe_allow_html=True)
components.html(adsterra_code, height=90)
st.markdown('</div>', unsafe_allow_html=True)

# ---------------------------------------------------------
# BARRE DE NAVIGATION SUPÉRIEURE (HISTORIQUE GAUCHE / TITRE / CRAYON DROITE)
# ---------------------------------------------------------
...
if api_keys_list:
    if st.session_state.show_history:
        ...
        # 2. Bannière publicitaire épinglée juste au-dessus de la barre de message
