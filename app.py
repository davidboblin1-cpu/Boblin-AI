...
# --- API KEYS & ROTATION SETUP (CORRIGÉ JUSQU'À 20) ---
api_keys = []
for i in range(1, 21):
...
if not client:
  error_config_msg = (
      "⚠️ Veuillez configurer vos clés API (`GEMINI_API_KEY_1`, `GEMINI_API_KEY_2`, etc.) dans les"
      " secrets de Streamlit."
      if is_french
      else "⚠️ Please configure your API keys (`GEMINI_API_KEY_1`, `GEMINI_API_KEY_2`, etc.) in"
      " Streamlit secrets."
  )
