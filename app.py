...
# ---------------------------------------------------------
# CHARGEMENT DES CLÉS API & ROTATION AUTOMATIQUE (MODÈLE 3.6 FLASH)
# ---------------------------------------------------------
...
if not api_keys_list:
    ...
    def call_gemini_with_rotation(contents_data, is_chat=False, chat_history=None):
        """Tente d'appeler l'API Gemini 3.6 Flash avec rotation automatique des clés en cas de saturation ou d'erreur de quota."""
        ...
        for attempt in range(num_keys):
            ...
            try:
                ...
                error_str = str(e)
                # Si l'erreur est liée aux quotas, à une surcharge ou à une limite de requêtes, on passe à la clé suivante
    ...
    # -----------------------------------------------------
    # MODE 2 : CHAT TEXTE (AVEC GEMINI-3.6-FLASH ET ROTATION DE CLÉS)
    # -----------------------------------------------------
    else:
