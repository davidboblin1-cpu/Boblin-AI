...
def add_watermark(image_url, watermark_text="boblin-ai"):
  """Télécharge l'image générée et ajoute 'boblin-ai' en bas à gauche"""
  try:
    ...
    x = int(width * 0.03)
    y = int(height - height * 0.07)

    # Contour sombre et texte blanc pour une parfaite lisibilité
    outline_color = (0, 0, 0, 220)
    text_color = (255, 255, 255, 230)

    for adj_x, adj_y in [(-1, -1), (1, -1), (-1, 1), (1, 1)]:
      draw.text((x + adj_x, y + adj_y), watermark_text, fill=outline_color)
        ...
        try:
          ...
          if is_video_request:
            ...
            with st.spinner(
              ...
              # Application automatique de la signature "boblin-ai"
