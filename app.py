...
if not client:
  error_config_msg = (
      "⚠️ Veuillez configurer au moins une clé API (`GEMINI_API_KEY`) dans les"
      " secrets de Streamlit."
      if is_french
      else "⚠️ Please configure at least one API key (`GEMINI_API_KEY`) in"
      " Streamlit secrets."
  )
