...
if not api_keys_list:
    ...
    # -----------------------------------------------------
    # MODE 1 : STUDIO IMAGE & AFFICHAGE DIRECT ROBUSTE
    # -----------------------------------------------------
                ...
                with st.spinner("Boblin AI conçoit et génère votre image..."):
                    try:
                        ...
                        if response and hasattr(response, 'text'):
                            ...
                            # Étape 2 : Construction de l'URL et téléchargement des octets en mémoire
                            ...
                            # Étape 3 : Affichage natif et fluide de l'image
