...
# Correction du 'False' avec une majuscule ici :
...
if not api_keys_list:
    ...
    if app_mode == "🎨 Studio Image":
        ...
        image_prompt = st.text_area("Décrivez l'image ou la modification souhaitée :", placeholder="Ex: Transforme ce personnage en style animé détaillé, change l'arrière-plan...")
                ...
                with st.spinner("Boblin AI conçoit et génère votre image avec Gemini 3.6 Flash..."):
                    try:
                        ...
                        if 'image' not in content_type.lower():
                            raise Exception("Le service n'a pas renvoyé une image valide.")
