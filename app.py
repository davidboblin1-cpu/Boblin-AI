...
# ---------------------------------------------------------
# STYLE CSS POUR MASQUER COMPLÈTEMENT LE MENU STREAMLIT ET ÉPURER
# ---------------------------------------------------------
st.markdown("""
    <style>
        ...
        /* Ajustement propre pour aligner les boutons du haut */
        .stButton button {
            width: 100%;
            border-radius: 8px;
            font-size: 16px;
...
with col_left:
    if st.button("🕒", help="Voir mon historique"):
            ...
            with st.chat_message("assistant"):
                with st.spinner("Boblin AI réfléchit..."):
                    try:
                        ...
                        # Utilisation d'un modèle actif et stable (gemini-2.0-flash)
