...
if not api_keys_list:
    ...
    # -----------------------------------------------------
    # MODE 1 : STUDIO IMAGE & AFFICHAGE DIRECT
    # -----------------------------------------------------
        ...
        if st.button("✨ Exécuter", use_container_width=True):
            if not image_prompt.strip():
                ...
                with st.spinner("Boblin AI conçoit et génère votre image..."):
                    try:
                        # Étape 1 : Création du prompt visuel artistique par Gemini
                        if uploaded_file:
                            contents = [
                                input_image, 
                        ...
                        if response and hasattr(response, 'text'):
                            ...
                            # Étape 2 : Construction de l'URL de rendu graphique
                            ...
                            # Étape 3 : Affichage HTML direct compatible mobile/web
                            st.markdown(f"""
                                <div style="text-align: center; margin-top: 10px;">
                                    <img src="{image_url}" style="width: 100%; border-radius: 12px; border: 1px solid #30363d;" alt="Résultat Boblin AI">
                                    <p style="color: #8b949e; font-size: 14px; margin-top: 5px;">✨ Résultat généré par Boblin AI</p>
                                </div>
                            """, unsafe_allow_html=True)
                        else:
