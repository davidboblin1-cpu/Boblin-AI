...
# ---------------------------------------------------------
# STYLE CSS POUR ÉPINGLER LES PUBS VRAIMENT EN HAUT ET EN BAS
# ---------------------------------------------------------
st.markdown("""
    <style>
        ...
        /* Bannière du haut épinglée de force */
        .top-banner-fixed {
            position: fixed;
            top: 0;
            left: 0;
        ...
        /* Bannière du bas épinglée juste au-dessus du champ de saisie */
        .bottom-banner-fixed {
            position: fixed;
            bottom: 70px;
            left: 0;
        ...
        /* Marges pour que le contenu ne se cache pas sous les bannières fixes */
        .block-container {
            ...
            with st.chat_message("assistant"):
                with st.spinner("Boblin AI réfléchit..."):
                    try:
                        ...
                        # Modèle mis à jour exigé par l'API
