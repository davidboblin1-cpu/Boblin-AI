...
st.markdown(
    """
<style>
/* Forcer le défilement fluide et tactile sur mobile */
html, body {
    height: 100%;
...
/* Conteneur principal avec défilement forcé et grande marge basse */
.block-container {
    max-width: 900px;
    padding-top: 10px;
...
/* Correction de la barre de saisie : texte blanc et fond sombre */
