...
# ---------------------------------------------------------
# STYLE CSS POUR UNE INTERFACE ÉPURÉE (MASQUAGE MENU & PUBS DU BAS)
# ---------------------------------------------------------
st.markdown("""
    <style>
...
# Gestion d'un identifiant utilisateur unique par navigateur si non connecté
...
user_name = current_user.split("@")[0] if "@" in current_user else "Utilisateur"

# Barre latérale discrète pour configurer un email si l'utilisateur le souhaite
with st.sidebar:
    st.markdown("### 👤 Mon Compte")
    input_email = st.text_input("Associer un e-mail :", value="" if "session_" in current_user else current_user, placeholder="votre@email.com")
...
# ---------------------------------------------------------
# BARRE DE NAVIGATION SUPÉRIEURE (HISTORIQUE GAUCHE / CRAYON DROITE)
# ---------------------------------------------------------
