...
# =========================================================
# DESIGN & CORRECTIF ANTI-RECHARGEMENT MOBILE (CSS)
# =========================================================

st.markdown(
    """
<style>
/* 1. DÉSACTIVER LE PULL-TO-REFRESH (L'ACTUALISATION NON VOULUE) */
html, body, .stApp {
    overscroll-behavior-y: none !important; /* Empêche l'apparition du cercle de rechargement */
...
.block-container {
    max-width: 900px;
    padding-top: 15px;
    padding-bottom: 120px !important; /* Laisse de l'espace pour la barre de saisie */
}

/* 3. STYLE DES MESSAGES (Adapté pour les textes très longs) */
[data-testid="stChatMessage"] {
    ...
    height: auto !important; /* Permet au message de s'agrandir selon le texte */
}
...
[data-testid="stChatMessage"] li {
    ...
    word-wrap: break-word !important; /* Empêche le texte de déborder sur les côtés */
    white-space: pre-wrap !important; /* Respecte les sauts de ligne */
}

/* 4. BARRE DE SAISIE CORRIGÉE */
    ...
    if st.button("🗑️", use_container_width=True, help="Effacer la conversation"):
        st.session_state.messages = [{
            ...
            "content": (
                ...
                "N'hésite pas à me donner le sujet de ton devoir ou à coller ton énoncé pour qu'on le résolve étape par étape !"
            )
        }]
        st.rerun()
