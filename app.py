            ...
            if not image_prompt.strip():
                ...
                with st.spinner("Boblin AI conçoit et génère votre image..."):
                    try:
                        ...
                        # Vérification de sécurité pour s'assurer qu'on a bien reçu une image
                        if 'image' not in content_type.lower():
                            raise Exception("Le service de génération d'image n'a pas renvoyé une image valide (erreur de réponse). Réessayez.")
