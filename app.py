        ...
        if st.button("✨ Exécuter", use_container_width=True):
            if not image_prompt.strip():
                ...
                with st.spinner("Boblin AI prépare votre image..."):
                    try:
                        # Étape 1 : Utilisation de Gemini pour traduire/affiner le prompt en anglais
                        if input_image:
                            contents = [
                                input_image, 
                        ...
                        # Étape 2 : Affichage direct de l'image via un lien dynamique sécurisé (zéro erreur 500)
